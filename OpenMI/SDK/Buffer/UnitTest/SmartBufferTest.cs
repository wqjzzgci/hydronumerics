...
namespace HydroNumerics.OpenMI.Sdk.Buffer.UnitTest
{
    ...
    /// <summary>
    ///This is a test class for DummyTest and is intended
    ///to contain all DummyTest Unit Tests
    ///</summary>
    [TestClass()]
	...
	public void GetValues_TimeStampsToTimeStamp_02()
	{
		...
		//		http://projects.dhi.dk/harmonIT/WP6/SourceCodeDocumentation/HydroNumerics.OpenMI.Sdk.Buffer.TestCode.htm
...
[TestMethod()] 
		...
		public void GetValues_TimeSpansToTimeStamp_01()
		{
			...
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(10),new TimeStamp(13)), new ScalarSet(new double[3] { 5, 12,  5 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(13),new TimeStamp(16)), new ScalarSet(new double[3] { 7, 11,  5 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(16),new TimeStamp(20)), new ScalarSet(new double[3] { 9, 10,  5 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(20),new TimeStamp(27)), new ScalarSet(new double[3] { 2,  7,  5 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(27),new TimeStamp(30)), new ScalarSet(new double[3] { -5, 6,  5 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(30),new TimeStamp(48)), new ScalarSet(new double[3] { 7,  3,  5 }));
		...
		public void GetValues_TimeSpansToTimeSpans()
		{
			...
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(10),new TimeStamp(13)), new ScalarSet(new double[1] { 1 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(13),new TimeStamp(16)), new ScalarSet(new double[1] { 2 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(16),new TimeStamp(19)), new ScalarSet(new double[1] { 3 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(19),new TimeStamp(27)), new ScalarSet(new double[1] { 4 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(27),new TimeStamp(30)), new ScalarSet(new double[1] { 5 }));
			smartBuffer.AddValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(30),new TimeStamp(48)), new ScalarSet(new double[1] { 6 }));

			Assert.AreEqual( 1.0 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(9),new TimeStamp(13)))).GetScalar(0));
			Assert.AreEqual( 1.0 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(10),new TimeStamp(13)))).GetScalar(0));
			Assert.AreEqual( 1.0 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(11),new TimeStamp(12)))).GetScalar(0));
			Assert.AreEqual( 2.5 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(13),new TimeStamp(19)))).GetScalar(0));
			Assert.AreEqual( 2.5 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(14.5),new TimeStamp(17.5)))).GetScalar(0));
		...
		public void GetValues_TimeStampsToTimeSpan_01()
		{
			...
			Assert.AreEqual( 24.5/6 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(3),new TimeStamp(9)))).GetScalar(0),0.0000000001);
			Assert.AreEqual( 49.25/11 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(3),new TimeStamp(14)))).GetScalar(0),0.0000000001);
			Assert.AreEqual( 13.0/4.0 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(13),new TimeStamp(17)))).GetScalar(0));

			smartBuffer.RelaxationFactor = 0.0;
			Assert.AreEqual( 3 , ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(13),new TimeStamp(17)))).GetScalar(0));

			smartBuffer.RelaxationFactor = 1.0;
			Assert.AreEqual( 3, ((ScalarSet) smartBuffer.GetValues(new HydroNumerics.OpenMI.Sdk.Backbone.TimeSpan(new TimeStamp(1),new TimeStamp(5)))).GetScalar(0));
