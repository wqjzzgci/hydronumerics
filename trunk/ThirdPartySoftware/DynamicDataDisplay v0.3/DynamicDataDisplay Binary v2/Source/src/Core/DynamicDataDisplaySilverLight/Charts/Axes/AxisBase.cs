...
namespace Microsoft.Research.DynamicDataDisplay.Charts
{
    ...
    public abstract class AxisBase<T> : ContentControl, ITypedAxis<T>, IValueConversion<T> where T:IComparable
    {
        /// <summary>
        ...
        public string DebugString {
            get {
                return axisControl.DebugString;
            }
            set {
                axisControl.DebugString = value;
            }
        }
#endif
        ...
        public IPartsProvider<T> PartsProvider {
            get {
                return axisControl.PartsProvider;
            }
            set { axisControl.PartsProvider = value;}
        }
