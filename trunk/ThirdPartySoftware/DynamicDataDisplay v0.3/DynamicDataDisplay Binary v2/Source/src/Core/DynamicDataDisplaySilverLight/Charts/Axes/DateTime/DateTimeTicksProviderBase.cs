...
namespace Microsoft.Research.DynamicDataDisplay.Charts
{
    public abstract class TimeTicksProviderBase<T> : ITicksProvider<T>
    {
        ...
        public ITicksProvider<T> Clone()
        {
            return base.MemberwiseClone() as ITicksProvider<T>;
        }

        protected IDateTimeTicksStrategy strategy = new DefaultDateTimeTicksStrategy();
