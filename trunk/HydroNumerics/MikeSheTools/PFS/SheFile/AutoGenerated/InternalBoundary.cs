...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class InternalBoundary: PFSMapper
  {

    private DFS_2D_DATA_FILE _dFS_2D_DATA_FILE;
    private SHAPE_FILE _sHAPE_FILE;
    private List<InternalBoundaryProp> _internalBoundaryProps = new List<InternalBoundaryProp>();
    ...
    public List<InternalBoundaryProp> InternalBoundaryProps
   {
     get { return _internalBoundaryProps; }
    }
