...
namespace OpenMI.Standard2.TimeSpace
{
    /// <summary>
    /// <para>
    /// An <see cref="IBaseLinkableComponent"/> providing exchange items of type time-space.
    /// </para> <para>
    /// See <see cref="IBaseLinkableComponent"/> for details
    /// </para>
    /// </summary>
    public interface ITimeSpaceComponent : IBaseLinkableComponent, ITimeExtension
    {
