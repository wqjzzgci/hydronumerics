...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class SatWQLayers: PFSMapper
  {


    internal SatWQLayers(PFSSection Section)
    {
      _pfsHandle = Section;
    ...
    public int NumberOfWQLayers
    {
      get
      {
        return _pfsHandle.GetKeyword("NumberOfWQLayers", 1).GetParameter(1).ToInt();
      }
      set
      {
        _pfsHandle.GetKeyword("NumberOfWQLayers", 1).GetParameter(1).Value = value;
      }
    }
