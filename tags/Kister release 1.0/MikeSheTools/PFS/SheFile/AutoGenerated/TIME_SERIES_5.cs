...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class TIME_SERIES_5: PFSMapper
  {

    private VEG_PROP_FILES5 _vEG_PROP_FILES;
    private List<DFS_2D_DATA_FILE> _tIME_SERIES_FILE_1s = new List<DFS_2D_DATA_FILE>();

    internal TIME_SERIES_5(PFSSection Section)
    {
      _pfsHandle = Section;
      ...
      for (int i = 1; i <= Section.GetSectionsNo(); i++)
      {
        ...
        {
        case "VEG_PROP_FILES":
          _vEG_PROP_FILES = new VEG_PROP_FILES5(sub);
          break;
          default:
    ...
    public VEG_PROP_FILES5 VEG_PROP_FILES
    {
