...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class VEG_PROP_FILES: PFSMapper
  {

    private VegNo_1 _vegNo_1;

    internal VEG_PROP_FILES(PFSSection Section)
    {
      _pfsHandle = Section;
