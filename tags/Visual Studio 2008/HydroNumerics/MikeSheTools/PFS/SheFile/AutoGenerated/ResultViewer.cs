...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class ResultViewer: PFSMapper
  {


    internal ResultViewer(PFSSection Section)
    {
      _pfsHandle = Section;
    ...
    public int LayerNo
    {
      get
      {
        return _pfsHandle.GetKeyword("LayerNo", 1).GetParameter(1).ToInt();
      }
      set
      {
        _pfsHandle.GetKeyword("LayerNo", 1).GetParameter(1).Value = value;
      }
    }
