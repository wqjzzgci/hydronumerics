...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class VEG_PROP_FILES4: PFSMapper
  {

    private VegNo_18 _vegNo_1;

    internal VEG_PROP_FILES4(PFSSection Section)
    {
      _pfsHandle = Section;
