...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class CompControlParaRivEx: PFSMapper
  {


    internal CompControlParaRivEx(PFSSection Section)
    {
      _pfsHandle = Section;
    ...
    public double MaxFractionHPointVolume
    {
      get
      {
        return _pfsHandle.GetKeyword("MaxFractionHPointVolume", 1).GetParameter(1).ToDouble();
      }
      set
      {
        _pfsHandle.GetKeyword("MaxFractionHPointVolume", 1).GetParameter(1).Value = value;
      }
    }
