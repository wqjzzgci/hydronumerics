...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class Decay_Processes: PFSMapper
  {


    internal Decay_Processes(PFSSection Section)
    {
      _pfsHandle = Section;
    ...
    public int NumberOfDecay
    {
      get
      {
        return _pfsHandle.GetKeyword("NumberOfDecay", 1).GetParameter(1).ToInt();
      }
      set
      {
        _pfsHandle.GetKeyword("NumberOfDecay", 1).GetParameter(1).Value = value;
      }
    }
