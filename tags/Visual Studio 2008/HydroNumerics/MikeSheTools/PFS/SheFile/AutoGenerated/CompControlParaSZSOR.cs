...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class CompControlParaSZSOR: PFSMapper
  {


    internal CompControlParaSZSOR(PFSSection Section)
    {
      _pfsHandle = Section;
    ...
    public double OverRelaxFactor
    {
      get
      {
        return _pfsHandle.GetKeyword("OverRelaxFactor", 1).GetParameter(1).ToDouble();
      }
      set
      {
        _pfsHandle.GetKeyword("OverRelaxFactor", 1).GetParameter(1).Value = value;
      }
    }
