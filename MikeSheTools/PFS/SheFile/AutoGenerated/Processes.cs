...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class Processes: PFSMapper
  {

    private Decay_Processes _decay_Processes;
    private Sorption_Processes _sorption_Processes;

    internal Processes(PFSSection Section)
    {
      _pfsHandle = Section;
      ...
      for (int i = 1; i <= Section.GetSectionsNo(); i++)
      {
        ...
        case "Decay_Processes":
          _decay_Processes = new Decay_Processes(sub);
          break;
        case "Sorption_Processes":
          _sorption_Processes = new Sorption_Processes(sub);
          break;
          default:
    ...
    public Decay_Processes Decay_Processes
    {
     get { return _decay_Processes; }
    }

    public Sorption_Processes Sorption_Processes
    {
