...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class CompLayersGeoSZ: PFSMapper
  {

    private Layer_12 _layer_1;

    internal CompLayersGeoSZ(PFSSection Section)
    {
      _pfsHandle = Section;
