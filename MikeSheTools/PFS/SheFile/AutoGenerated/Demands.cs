...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class Demands: PFSMapper
  {
    ...
    public int NO_DEMANDS
    {
      get
      {
        return _pfsHandle.GetKeyword("NO_DEMANDS", 1).GetParameter(1).ToInt();
      }
      set
      {
        _pfsHandle.GetKeyword("NO_DEMANDS", 1).GetParameter(1).Value = value;
      }
    }
