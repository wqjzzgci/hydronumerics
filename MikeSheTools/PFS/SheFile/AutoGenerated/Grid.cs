...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class Grid: PFSMapper
  {


    internal Grid(PFSSection Section)
    {
      _pfsHandle = Section;
    ...
    public double TransparencyVal
    {
      get
      {
        return _pfsHandle.GetKeyword("TransparencyVal", 1).GetParameter(1).ToDouble();
      }
      set
      {
        _pfsHandle.GetKeyword("TransparencyVal", 1).GetParameter(1).Value = value;
      }
    }
