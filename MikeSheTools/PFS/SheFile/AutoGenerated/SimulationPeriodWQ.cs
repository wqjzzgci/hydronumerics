...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class SimulationPeriodWQ: PFSMapper
  {


    internal SimulationPeriodWQ(PFSSection Section)
    {
      _pfsHandle = Section;
    ...
    public int RecyclingType
    {
      get
      {
        return _pfsHandle.GetKeyword("RecyclingType", 1).GetParameter(1).ToInt();
      }
      set
      {
        _pfsHandle.GetKeyword("RecyclingType", 1).GetParameter(1).Value = value;
      }
    }
