...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class ExtraParam_1: PFSMapper
  {
    ...
    public int Value
    {
      get
      {
        return _pfsHandle.GetKeyword("Value", 1).GetParameter(1).ToInt();
      }
      set
      {
        _pfsHandle.GetKeyword("Value", 1).GetParameter(1).Value = value;
      }
    }
