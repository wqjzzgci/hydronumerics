...
namespace HydroNumerics.MikeSheTools.PFS.SheFile
{
  ...
  /// </summary>
  public partial class OuterBoundary: PFSMapper
  {


    internal OuterBoundary(PFSSection Section)
    {
      _pfsHandle = Section;
    ...
    public int NumberOfBoundaryConditions
    {
      get
      {
        return _pfsHandle.GetKeyword("NumberOfBoundaryConditions", 1).GetParameter(1).ToInt();
      }
      set
      {
        _pfsHandle.GetKeyword("NumberOfBoundaryConditions", 1).GetParameter(1).Value = value;
      }
    }
