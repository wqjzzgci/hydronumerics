...
namespace HydroNumerics.MikeSheTools.PFS.VegetationFile
{
  ...
  /// </summary>
  public partial class UserDefVegDevelopment: PFSMapper
  {

    private List<Stage_1> _stage_1s = new List<Stage_1>();

    internal UserDefVegDevelopment(PFSSection Section)
    {
      _pfsHandle = Section;
