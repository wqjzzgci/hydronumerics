...
namespace HydroNumerics.MikeSheTools.PFS.VegetationFile
{
  ...
  /// </summary>
  public partial class Irrigation: PFSMapper
  {

    private List<Stage_12> _stage_1s = new List<Stage_12>();

    internal Irrigation(PFSSection Section)
    {
      _pfsHandle = Section;
      ...
      for (int i = 1; i <= Section.GetSectionsNo(); i++)
      {
        ...
        switch (sub.Name)
        {
          default:
            ...
            {
              _stage_1s.Add(new Stage_12(sub));
              break;
            }
